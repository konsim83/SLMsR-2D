...
function writeSolution_at_timestep(solution :: FEM.Solution_FEM, mesh :: Mesh.TriMesh, k_time, filename)
...
function writeSolution_all_steps(solution :: FEM.Solution_FEM, mesh :: Mesh.TriMesh, filename)
