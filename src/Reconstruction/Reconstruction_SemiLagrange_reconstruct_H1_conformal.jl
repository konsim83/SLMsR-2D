function reconstruct_H1_conformal(solution :: FEM.Solution_MsFEM,
    ...
    uBasisOpt = reconstruct_H1_conformal(solution,
                                            mesh_collection,
                                            dof_collection,
                                            ref_el_local,
                                            quad_local,
...
function reconstruct_H1_conformal(solution :: FEM.Solution_MsFEM,
    ...
    # Reconstruct edges
    reconstruct_edge_L2!(uBasisOpt, mesh_local, uGlobal, uBasis0, uOrig, 1, k[4])
    reconstruct_edge_L2!(uBasisOpt, mesh_local, uGlobal, uBasis0, uOrig, 2, k[4])
    reconstruct_edge_L2!(uBasisOpt, mesh_local, uGlobal, uBasis0, uOrig, 3, k[4])
