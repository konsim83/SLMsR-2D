...
function Gaussian_1(T :: Float64, k :: Int)
        
    info_prob = "Evolution of symmetric Gaussian_1."
    type_info = "ADE"
    file_name = "Gaussian_1"
    ...
    return Gaussian_1(info_prob, type_info, file_name,
                    T, 
...
function u_init(problem :: Gaussian_1, x :: Array{Float64})
