struct Gaussian_R_4 <: AbstractPhysicalProblem
...
function Gaussian_R_4(T :: Float64, psi :: Float64, k :: Int)
        
    info_prob = "Evolution of symmetric Gaussian_R_4 (classic velocity)."
    type_info = "ADE"
    file_name = "Gaussian_R_4"
    ...
    return Gaussian_R_4(info_prob, type_info, file_name,
                    T, 
...
"""
    diffusion(problem :: Gaussian_R_4, t :: Float64, x :: Array{Float64,2})

    Diffusion is represented by a positive 2-by-2 tensor.

"""
function diffusion(problem :: Gaussian_R_4, t :: Float64, x :: Array{Float64,2})
...
"""
    diffusion(problem :: Gaussian_R_4,  t :: Float64, x :: Array{Array{Float64,2},1})
    
    Diffusion is represented by a positive 2-by-2 tensor.

"""
function diffusion(problem :: Gaussian_R_4,  t :: Float64, x :: Array{Array{Float64,2},1})
...
"""
    velocity(problem :: Gaussian_R_4,  t :: Float64, x :: Array{Float64,2})

    Velocity is represented by a 2-vector. The solenoidal part can be
    represented by a stream function.

"""
function velocity(problem :: Gaussian_R_4,  t :: Float64, x :: Array{Float64,2})
...
"""
    velocity(problem :: Gaussian_R_4,  t :: Float64, x :: Array{Array{Float64,2},1})

    Velocity is represented by a 2-vector. The solenoidal part can be
    represented by a stream function.

"""
function velocity(problem :: Gaussian_R_4,  t :: Float64, x :: Array{Array{Float64,2},1})
...
function u_init(problem :: Gaussian_R_4, x :: Array{Float64})
