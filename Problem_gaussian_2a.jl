...
"""
    diffusion(problem :: Gaussian_2a,  t :: Float64, x :: Array{Float64,3})

    Diffusion is represented by a positive 2-by-2 tensor.

"""
function diffusion(problem :: Gaussian_2a,  t :: Float64, x :: Array{Float64,3})
...
"""
    velocity(problem :: Gaussian_2a,  t :: Float64, x :: Array{Float64,3})

    Velocity is represented by a 2-vector. The solenoidal part can be
    represented by a stream function.

"""
function velocity(problem :: Gaussian_2a,  t :: Float64, x :: Array{Float64,3})
...
function u_init(problem :: Gaussian_2a, x :: Array{Float64,1})
...
function u_init(problem :: Gaussian_2a, x :: Array{Float64,2})
...
function u_init(problem :: Gaussian_2a, x :: Array{Float64,3})
